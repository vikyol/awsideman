        ...
        try:
            ...
            if not cache_dir.exists():
                try:
                    ...
                    logger.error(f"File backend health check failed - cannot create cache directory: {e}")
                    return False
            ...
            try:
                ...
                logger.error(f"File backend health check failed - cannot write to cache directory: {e}")
                return False
