...
class CachedAwsClient:
    ...
    def __init__(self, client_manager: AWSClientManager, cache_manager: Optional[CacheManager] = None):
        """
    ...
    def _execute_with_cache(self, operation: str, params: Dict[str, Any], 
                           api_call: Callable[[], Any]) -> Any:
        """
...
class CachedOrganizationsClient:
    ...
    def list_roots(self) -> List[Dict[str, Any]]:
        ...
        return self._cached_aws_client._execute_with_cache(
            'list_roots',
            {},
            lambda: self._organizations_client.list_roots()
        )
...
def create_cached_client_manager(profile: Optional[str] = None, 
                               region: Optional[str] = None,
                               cache_config: Optional[CacheConfig] = None) -> CachedAwsClient:
    """
