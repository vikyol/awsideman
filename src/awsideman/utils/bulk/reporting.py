...
from .batch import BulkOperationResults, AssignmentResult
...
class ReportGenerator:
    ...
    def generate_summary_report(self, results: BulkOperationResults, operation: str):
        ...
        if results.start_time and results.end_time:
            ...
            self.console.print(Panel(
                timing_table,
                title="[dim]Timing Information[/dim]",
                border_style="dim"
            ))
    ...
    def generate_performance_report(self, results: BulkOperationResults):
        ...
        processing_times = [r.processing_time for r in all_results if r.processing_time and r.processing_time > 0]
        ...
        try:
            with open(output_file, 'w', encoding='utf-8') as f:
                ...
                for i, result in enumerate(all_results, 1):
                    ...
                    f.write(f"{result.principal_name} -> {result.permission_set_name} @ {result.account_name}")
