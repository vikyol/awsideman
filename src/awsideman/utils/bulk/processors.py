...
class CSVProcessor:
    ...
    def validate_format(self) -> List[ValidationError]:
        ...
        try:
            ...
            errors.append(ValidationError(f"File encoding error: {str(e)}. Please ensure file is UTF-8 encoded"))
...
class JSONProcessor:
    ...
    def __init__(self, file_path: Path):
        ...
        self.optional_fields = {'principal_type', 'account_id', 'permission_set_arn', 'principal_id'}
    ...
    def _validate_field_value(self, field: str, value: Any, assignment_prefix: str) -> List[ValidationError]:
    ...
    def parse_assignments(self) -> List[Dict[str, Any]]:
        ...
        for idx, assignment in enumerate(data['assignments']):
            ...
            # Set default values for optional fields
            if 'principal_type' not in cleaned_assignment or not cleaned_assignment['principal_type']:
