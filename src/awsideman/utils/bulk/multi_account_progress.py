            ...
            self.detailed_stats.update(
                {
                    ...
                    "progress_percentage": (total_processed / self.total_items * 100)
                    if self.total_items > 0
                    else 0,
                    "successful_percentage": (self.successful_count / total_processed * 100)
                    if total_processed > 0
                    else 0,
                    "failed_percentage": (self.failed_count / total_processed * 100)
                    if total_processed > 0
                    else 0,
                ...
                self.detailed_stats.update(
                    {
                        ...
                        "time_per_account": elapsed_time / total_processed
                        if total_processed > 0
                        else 0,
                    }
                )
