...
class PreviewGenerator:
    ...
    def generate_preview_report(self, assignments: List[Dict[str, Any]], operation_type: str = "assign") -> PreviewSummary:
    ...
    def _calculate_summary(self, assignments: List[Dict[str, Any]]) -> PreviewSummary:
        ...
        unique_permission_sets = len(set(
            a.get('permission_set_name', '') for a in assignments 
            if a.get('permission_set_name')
        ))
        
        unique_accounts = len(set(
            a.get('account_name', '') for a in assignments 
