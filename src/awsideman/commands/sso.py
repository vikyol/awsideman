    ...
    try:
        ...
        for instance in instances:
            ...
            for p_name, p_data in profiles.items():
                if (p_data.get("sso_instance_arn") == instance_arn and 
                    p_data.get("identity_store_id") == identity_store_id and
                    p_data.get("sso_instance_name")):
...
def set_instance(
    ...
    name: Optional[str] = typer.Option(None, "--name", "-n", help="Display name for the SSO instance"),
    profile: Optional[str] = typer.Option(None, "--profile", "-p", help="AWS profile to use"),
):
...
def set_instance_name(
    ...
    profiles[profile_name]["sso_instance_name"] = name
    config.set("profiles", profiles)
    console.print(f"[green]SSO instance display name set to '{name}' for profile '{profile_name}'.[/green]")
...
def instance_info(
    ...
    try:
        ...
        console.print(f"[yellow]Could not retrieve additional instance information: {str(e)}[/yellow]")