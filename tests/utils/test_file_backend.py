...
class TestFileBackend:
    ...
    def test_invalidate_permission_error(self):
        ...
        with patch.object(self.backend.path_manager, 'delete_cache_file', 
    ...
    def test_get_stats_error_handling(self):
        ...
        with patch.object(self.backend.path_manager, 'list_cache_files', 
    ...
    def test_health_check_unexpected_error(self):
        ...
        with patch.object(self.backend.path_manager, 'get_cache_directory', 
