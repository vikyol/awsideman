...
class TestMultiAccountModelsIntegration:
    ...
    def test_tag_filtering_workflow(self):
        ...
        prod_accounts = [acc for acc in accounts if acc.matches_tag_filter("Environment", "Production")]
        ...
        prod_web_accounts = [
            ...
            if acc.matches_tag_filter("Environment", "Production") and 
               acc.matches_tag_filter("Service", "Web")
        ]
