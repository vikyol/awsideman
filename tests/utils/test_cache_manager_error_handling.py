...
class TestCacheManagerErrorHandling(unittest.TestCase):
    ...
    def test_cache_disabled_on_directory_creation_failure(self):
        ...
        with patch.object(
            ...
            cache_manager = CacheManager(
                config=CacheConfig(enabled=True), base_cache_dir="/invalid/path"
            )
    ...
    def test_cache_size_management(self):
        ...
        cache_manager = CacheManager(config=small_config, base_cache_dir=self.temp_dir)
        ...
        _size_info = cache_manager.get_cache_size_info()
