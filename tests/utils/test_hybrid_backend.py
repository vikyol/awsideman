...
from src.awsideman.cache.backends.base import BackendHealthStatus, CacheBackendError
...
class TestHybridBackend:
    ...
    def hybrid_backend(self, mock_file_backend, mock_dynamodb_backend):
        ...
        return HybridBackend(
            local_backend=mock_file_backend, remote_backend=mock_dynamodb_backend, local_ttl=300
        )

    def test_init(self, mock_file_backend, mock_dynamodb_backend):
        """Test hybrid backend initialization."""
        backend = HybridBackend(
            local_backend=mock_file_backend, remote_backend=mock_dynamodb_backend, local_ttl=600
        )
    ...
    def test_get_remote_cache_hit_with_promotion(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_get_remote_cache_hit_no_promotion(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_get_local_backend_error(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_get_remote_backend_error(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_set_success(self, hybrid_backend, mock_file_backend, mock_dynamodb_backend):
        ...
        mock_dynamodb_backend.set.assert_called_once_with(
            "test_key", test_data, 3600, "test_operation"
        )
    ...
    def test_set_local_failure_remote_success(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_invalidate_partial_failure(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_invalidate_remote_failure(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_get_stats(self, hybrid_backend, mock_file_backend, mock_dynamodb_backend):
        ...
        # Set up mock stats
        local_stats = {"backend_type": "file", "valid_entries": 10, "total_size_mb": 5.2}
        remote_stats = {"backend_type": "dynamodb", "item_count": 50, "table_size_bytes": 1024000}
    ...
    def test_get_stats_backend_errors(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_health_check_local_healthy_only(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_health_check_remote_healthy_only(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_health_check_both_unhealthy(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_health_check_with_exceptions(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_should_promote_to_local_no_promotion(self, hybrid_backend):
        ...
        current_time = time.time()
        hybrid_backend._access_counts["test_key"] = 1
        hybrid_backend._last_access_times["test_key"] = (
            current_time - 200
    ...
    def test_get_most_accessed_keys(self, hybrid_backend):
        ...
        hybrid_backend._access_counts = {"key1": 5, "key2": 3, "key3": 8, "key4": 1}
    ...
    def test_sync_backends_unhealthy(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_get_detailed_health_status(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_get_detailed_health_status_mixed(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
    ...
    def test_get_detailed_health_status_fallback(
        self, hybrid_backend, mock_file_backend, mock_dynamodb_backend
    ):
