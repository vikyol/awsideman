...
from src.awsideman.aws_clients.manager import (
    ...
    _account_matches_tag_filter, OrganizationsClient
)
...
class TestBuildOrganizationHierarchy:
    ...
    def test_build_hierarchy_all_roots_fail(self, mock_organizations_client):
        ...
        mock_organizations_client.list_organizational_units_for_parent.side_effect = Exception("Test error")
...
class TestAccountMatchingFilters:
    ...
    def test_account_matches_tag_filter_multiple_tags(self):
        ...
        # All tags match
        assert _account_matches_tag_filter(account, {
    ...
    def test_search_accounts_with_tag_filter(self, mock_organizations_client):
        ...
        with patch('src.awsideman.utils.aws_client._get_all_accounts_in_organization') as mock_get_all:
            ...
            with patch('src.awsideman.utils.aws_client.get_account_details') as mock_get_details:
                ...
                results = search_accounts(mock_organizations_client, "dev", tag_filter={"Environment": "Development"})
