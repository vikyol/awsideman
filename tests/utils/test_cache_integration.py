...
from src.awsideman.encryption.provider import NoEncryption, EncryptionProviderFactory
...
class TestCacheIntegration:
    ...
    def test_encryption_key_rotation_integration(self):
        ...
        new_encryption = EncryptionProviderFactory.create_provider("aes256", key_manager=key_manager)
    ...
    def test_error_handling_integration(self):
        ...
        config = AdvancedCacheConfig(
            backend_type="file",
            file_cache_dir="/invalid/readonly/path"
        )
    ...
    def test_concurrent_access_simulation(self):
        ...
        test_data = [
            (f"concurrent_key_{i}", {"worker_id": i, "data": f"data_{i}"})
            for i in range(10)
        ]
