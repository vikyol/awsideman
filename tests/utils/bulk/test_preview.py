...
class TestPreviewGenerator:
    ...
    def test_display_resolution_errors_with_errors(self, preview_generator, console, sample_assignments):
    ...
    @patch('src.awsideman.utils.bulk.preview.Confirm.ask')
    def test_prompt_user_confirmation_keyboard_interrupt(self, mock_confirm, preview_generator, console):
