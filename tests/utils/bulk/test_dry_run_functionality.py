...
class TestDryRunFunctionality:
    ...
    def test_simulate_account_operation_assign_existing(self, multi_account_processor, sample_accounts):
    ...
    def test_simulate_account_operation_revoke_existing(self, multi_account_processor, sample_accounts):
    ...
    def test_simulate_account_operation_revoke_nonexistent(self, multi_account_processor, sample_accounts):
