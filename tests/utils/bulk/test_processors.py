...
from src.awsideman.utils.bulk import CSVProcessor, JSONProcessor, FileFormatDetector, ValidationError
...
class TestCSVProcessor:
    ...
    def test_init(self):
        ...
        assert processor.required_columns == {'principal_name', 'permission_set_name', 'account_name'}
        assert processor.optional_columns == {'principal_type', 'account_id', 'permission_set_arn', 'principal_id'}
...
class TestJSONProcessor:
    ...
    def test_init(self):
        ...
        assert processor.file_path == file_path
        assert processor.required_fields == {'principal_name', 'permission_set_name', 'account_name'}
        assert processor.optional_fields == {'principal_type', 'account_id', 'permission_set_arn', 'principal_id'}
