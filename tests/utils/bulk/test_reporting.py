...
from src.awsideman.utils.bulk.reporting import ReportGenerator
from src.awsideman.utils.bulk.batch import AssignmentResult, BulkOperationResults
...
class TestReportGenerator:
    ...
    def test_generate_detailed_report_all_types(self, report_generator, mock_console, sample_results):
    ...
    def test_generate_detailed_report_successful_only(self, report_generator, mock_console, sample_results):
    ...
    def test_generate_error_summary_with_errors(self, report_generator, mock_console, sample_results):
    ...
    def test_save_detailed_report_to_file_success(self, mock_file, report_generator, mock_console, sample_results):
    ...
    def test_save_detailed_report_to_file_error(self, mock_file, report_generator, mock_console, sample_results):
    ...
    def test_generate_detailed_report_with_file_output(self, report_generator, mock_console, sample_results):
