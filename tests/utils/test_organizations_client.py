...
class TestListRoots:
    ...
    def test_list_roots_client_error(self, organizations_client):
        ...
        with pytest.raises(click.exceptions.Exit):  # handle_aws_error calls typer.Exit which raises click.exceptions.Exit
            client.list_roots()
...
class TestDescribeAccount:
    ...
    def test_describe_account_success(self, organizations_client):
        ...
        mock_boto_client.describe_account.assert_called_once_with(
...
class TestListTagsForResource:
    ...
    def test_list_tags_for_resource_success(self, organizations_client):
        ...
        mock_boto_client.list_tags_for_resource.assert_called_once_with(
...
class TestListPoliciesForTarget:
    ...
    def test_list_policies_for_target_rcp_success(self, organizations_client):
        ...
        # Call method
        result = client.list_policies_for_target('ou-1234567890-abcdefgh', 'RESOURCE_CONTROL_POLICY')
        
        # Verify result
        assert result == expected_policies
        mock_boto_client.list_policies_for_target.assert_called_once_with(
            TargetId='ou-1234567890-abcdefgh',
...
class TestListParents:
    ...
    def test_list_parents_success(self, organizations_client):
        ...
        mock_boto_client.list_parents.assert_called_once_with(
    ...
    def test_list_parents_child_not_found(self, organizations_client):
        ...
        mock_boto_client.list_parents.side_effect = ClientError(
            error_response, 'ListParents'
        )
...
class TestIntegrationWithStubber:
    ...
    def test_complete_workflow_with_stubber(self, stubbed_organizations_client):
        ...
        # 1. List roots
        stubber.add_response('list_roots', {
            'Roots': [
                {
                    'Id': 'r-1234567890',
                    'Name': 'Root',
        ...
        # 2. List OUs for root
        stubber.add_response('list_organizational_units_for_parent', {
            'OrganizationalUnits': [
                {
                    'Id': 'ou-1234567890-abcdefgh',
                    'Name': 'Engineering',
        ...
        stubber.add_response('list_accounts_for_parent', {
            'Accounts': [
                {
                    'Id': '111111111111',
                    'Name': 'dev-account',
        ...
        # 4. Describe account
        stubber.add_response('describe_account', {
            'Account': {
                'Id': '111111111111',
                'Name': 'dev-account',
                'Email': 'dev@example.com',
        ...
        stubber.add_response('list_policies_for_target', {
            'Policies': [
                {
                    'Id': 'p-1234567890',
                    'Name': 'FullAWSAccess',
        ...
        stubber.add_response('list_parents', {
            'Parents': [
                {
                    'Id': 'ou-1234567890-abcdefgh',
                    'Type': 'ORGANIZATIONAL_UNIT'
