...
class TestAdvancedCacheConfig:
    ...
    def test_default_initialization(self):
        ...
        assert config.encryption_type == "none"  # Should be "none" when encryption is disabled by default
    ...
    def test_post_init_validation(self):
        ...
        with patch('src.awsideman.cache.config.logger') as mock_logger:
            ...
            assert config.encryption_type == "none"  # Should be "none" because encryption_enabled defaults to False
    ...
    def test_validate_dynamodb_invalid_table_name(self):
        ...
        config = AdvancedCacheConfig(
            backend_type="dynamodb",
            dynamodb_table_name="invalid@table#name"
        )
