...
class TestCacheManagerConfigurationInit:
    ...
    def test_init_with_provided_advanced_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch("src.awsideman.cache.manager.BackendFactory") as mock_factory, patch(
    ...
    def test_init_backend_creation_failure_with_fallback(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch("src.awsideman.cache.manager.BackendFactory") as mock_factory, patch(
                ...
                with patch(
                    "src.awsideman.cache.backends.file.FileBackend", return_value=mock_file_backend
