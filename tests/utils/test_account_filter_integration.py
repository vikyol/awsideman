...
class TestAccountFilterIntegration:
    ...
    def test_wildcard_filter_with_complex_organization(self):
        ...
        with patch('src.awsideman.aws_clients.manager.build_organization_hierarchy') as mock_build_hierarchy, \
    ...
    def test_filter_description_accuracy(self):
        ...
        filter_obj = AccountFilter("tag:Environment=Production,Team=Backend,Owner=John", self.mock_org_client)
        description = filter_obj.get_filter_description()
