...
class TestHybridBackendIntegration:
    ...
    def test_hybrid_backend_health_check_integration(self, mock_session):
        ...
        config = AdvancedCacheConfig(
            backend_type="hybrid", dynamodb_table_name="health-table", file_cache_dir=self.temp_dir
        )
    ...
    def test_hybrid_stats_integration(self, mock_session):
        ...
        mock_client.describe_table.return_value = {
            "Table": {"TableStatus": "ACTIVE", "ItemCount": 50, "TableSizeBytes": 1024}
        }
    ...
    def test_hybrid_invalidation_integration(self, mock_session):
        ...
        mock_table.scan.return_value = {
            "Items": [{"cache_key": "test_key1"}, {"cache_key": "test_key2"}]
        }
    ...
    def test_hybrid_error_handling_integration(self, mock_session):
        ...
        config = AdvancedCacheConfig(
            backend_type="hybrid", dynamodb_table_name="error-table", file_cache_dir=self.temp_dir
        )
    ...
    def test_hybrid_sync_backends_integration(self, mock_session):
        ...
        config = AdvancedCacheConfig(
            backend_type="hybrid", dynamodb_table_name="sync-table", file_cache_dir=self.temp_dir
        )
    ...
    def test_hybrid_backend_fallback_integration(self):
        ...
        with patch(
            ...
            fallback_backend.set(
                "fallback_key", encrypted_data, ttl=3600, operation="fallback_test"
            )
