...
class TestRollbackConfig:
    ...
    def setup_method(self):
        ...
        # Mock the CONFIG_DIR and CONFIG_FILE_YAML
        with patch("src.awsideman.utils.config.CONFIG_DIR", self.config_dir):
            with patch("src.awsideman.utils.config.CONFIG_FILE_YAML", self.config_file):
                self.config = Config()
    ...
    def test_validate_rollback_config_none_uses_current(self):
        ...
        self.config.config_data = {"rollback": {"retention_days": -1}}
