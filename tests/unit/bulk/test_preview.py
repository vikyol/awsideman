...
from src.awsideman.bulk.preview import PreviewGenerator, PreviewSummary
from src.awsideman.bulk.resolver import ResourceResolver
...
class TestPreviewGenerator:
    ...
    @patch("src.awsideman.bulk.preview.Confirm.ask")
    ...
    def test_prompt_user_confirmation_revoke_warning(self, preview_generator, console):
        ...
        with patch("src.awsideman.bulk.preview.Confirm.ask", return_value=True):
            summary = PreviewSummary(
                total_assignments=2,
                successful_resolutions=2,
                failed_resolutions=0,
    ...
    @patch("src.awsideman.bulk.processors.FileFormatDetector")
