...
class TestAccountResult:
    ...
    def test_is_successful(self):
        ...
        failed_result = AccountResult(
            account_id="123456789012", account_name="test-account", status="failed"
        )

        skipped_result = AccountResult(
            account_id="123456789012", account_name="test-account", status="skipped"
        )
...
class TestMultiAccountResults:
    ...
    def create_sample_results(self) -> tuple:
        ...
        skipped = [AccountResult("123456789015", "account-4", "skipped", processing_time=0.1)]
