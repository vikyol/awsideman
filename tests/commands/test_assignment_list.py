...
def sample_principal_info():
    ...
    return {
        "USER:user-1234567890abcdef": {
            "DisplayName": "John Doe"
        },
        "GROUP:group-1234567890abcdef": {
...
def test_list_assignments_with_filters(
    ...
    result = runner.invoke(app, [
        ...
        "--principal-id", "user-1234567890abcdef",
        "--principal-type", "USER"
    ])
...
def test_list_assignments_with_pagination(
    ...
    mock_sso_admin.list_account_assignments.side_effect = [
        {
            "AccountAssignments": sample_assignments[:1],
...
def test_list_assignments_api_error(
    ...
    mock_sso_admin.list_account_assignments.side_effect = ClientError(error_response, "ListAccountAssignments")
...
def test_list_assignments_principal_id_without_type(
    ...
    mock_console.print.assert_any_call("[yellow]Warning: Principal ID provided without principal type. Using default type 'USER'.[/yellow]")
