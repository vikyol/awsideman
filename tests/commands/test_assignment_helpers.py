...
class TestResolvePermissionSetInfo:
    ...
    @patch("src.awsideman.commands.assignment.console")
    def test_resolve_permission_set_info_not_found(
        self,
        mock_console,
        mock_sso_admin_client
    ):
        ...
        # Setup mocks
        mock_sso_admin_client.exceptions.ResourceNotFoundException = type('ResourceNotFoundException', (Exception,), {})
        mock_sso_admin_client.describe_permission_set.side_effect = mock_sso_admin_client.exceptions.ResourceNotFoundException()
        ...
        mock_console.print.assert_any_call("[red]Error: Permission set with ARN 'arn:aws:sso:::permissionSet/ssoins-1234567890abcdef/ps-1234567890abcdef' not found.[/red]")
    ...
    def test_resolve_permission_set_info_client_error(
        ...
        mock_sso_admin_client.describe_permission_set.side_effect = ClientError(error_response, "DescribePermissionSet")
    ...
    @patch("src.awsideman.commands.assignment.console")
    def test_resolve_permission_set_info_generic_error(
        self,
        mock_console,
        mock_sso_admin_client
    ):
...
class TestResolvePrincipalInfo:
    ...
    @patch("src.awsideman.commands.assignment.console")
    def test_resolve_principal_info_user_not_found(
        self,
        mock_console,
        mock_identity_store_client
    ):
        ...
        # Setup mocks
        mock_identity_store_client.exceptions.ResourceNotFoundException = type('ResourceNotFoundException', (Exception,), {})
        mock_identity_store_client.describe_user.side_effect = mock_identity_store_client.exceptions.ResourceNotFoundException()
        ...
        # Verify the console output
        mock_console.print.assert_any_call("[red]Error: User with ID 'user-1234567890abcdef' not found.[/red]")

    @patch("src.awsideman.commands.assignment.console")
    def test_resolve_principal_info_group_not_found(
        self,
        mock_console,
        mock_identity_store_client
    ):
        ...
        # Setup mocks
        mock_identity_store_client.exceptions.ResourceNotFoundException = type('ResourceNotFoundException', (Exception,), {})
        mock_identity_store_client.describe_group.side_effect = mock_identity_store_client.exceptions.ResourceNotFoundException()
        ...
        # Verify the console output
        mock_console.print.assert_any_call("[red]Error: Group with ID 'group-1234567890abcdef' not found.[/red]")
    ...
    def test_resolve_principal_info_user_client_error(
        ...
        mock_identity_store_client.describe_user.side_effect = ClientError(error_response, "DescribeUser")
    ...
    def test_resolve_principal_info_group_client_error(
        ...
        mock_identity_store_client.describe_group.side_effect = ClientError(error_response, "DescribeGroup")
    ...
    @patch("src.awsideman.commands.assignment.console")
    def test_resolve_principal_info_generic_error(
        self,
        mock_console,
        mock_identity_store_client
    ):
