...
def test_assignment_lifecycle_workflow(
    ...
    mock_sso_admin.list_account_assignments.return_value = {"AccountAssignments": []}  # No existing assignment
    ...
    mock_sso_admin.list_account_assignments.return_value = sample_assignment_response  # Assignment exists
...
def test_assignment_pagination_workflow(
    ...
    mock_sso_admin.list_account_assignments.side_effect = [first_page_response, second_page_response]
...
def test_assignment_error_scenarios(
    ...
    mock_sso_admin.describe_permission_set.return_value = {"PermissionSet": {"Name": "TestPermissionSet"}}
    mock_identity_store.describe_user.return_value = {"UserName": "testuser", "DisplayName": "Test User"}
...
def test_aws_api_error_handling(
    ...
    error_response = {
        "Error": {
            ...
            "Message": "Invalid permission set ARN"
        }
    }
    mock_sso_admin.list_account_assignments.return_value = {"AccountAssignments": []}
    mock_sso_admin.create_account_assignment.side_effect = ClientError(error_response, "CreateAccountAssignment")
    ...
    error_response = {
        "Error": {
            ...
            "Message": "Assignment operation in progress"
        }
    }
    existing_assignment_response = {
        "AccountAssignments": [
    ...
    mock_sso_admin.list_account_assignments.return_value = existing_assignment_response
    mock_sso_admin.delete_account_assignment.side_effect = ClientError(error_response, "DeleteAccountAssignment")
    mock_sso_admin.describe_permission_set.return_value = {"PermissionSet": {"Name": "TestPermissionSet"}}
    mock_identity_store.describe_user.return_value = {"UserName": "testuser", "DisplayName": "Test User"}
