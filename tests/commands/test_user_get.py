...
def test_get_user_by_username_successful(
    ...
    mock_identity_store.list_users.assert_called_once_with(
        ...
        Filters=[{"AttributePath": "UserName", "AttributeValue": "testuser"}],
    )
...
def test_get_user_by_email_successful(
    ...
    mock_identity_store.list_users.assert_any_call(
        IdentityStoreId="d-1234567890",
        Filters=[{"AttributePath": "UserName", "AttributeValue": "test.user@example.com"}],
    )

    # Second call should be getting all users
    mock_identity_store.list_users.assert_any_call(IdentityStoreId="d-1234567890")
...
def test_get_user_not_found(
    ...
    mock_console.print.assert_any_call(
        "[red]Error: No user found with username or email 'nonexistent'.[/red]"
    )
