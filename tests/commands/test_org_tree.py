...
from src.awsideman.utils.models import OrgNode, NodeType
...
def test_tree_command_visual_format(mock_client_manager, mock_org_client, mock_build_hierarchy, mock_config, mock_organization_tree):
...
@patch('src.awsideman.commands.org.OrganizationsClient')
@patch('src.awsideman.commands.org.AWSClientManager')
def test_tree_command_flat_format(mock_client_manager, mock_org_client, mock_build_hierarchy, mock_config, mock_organization_tree):
...
@patch('src.awsideman.commands.org.OrganizationsClient')
@patch('src.awsideman.commands.org.AWSClientManager')
def test_tree_command_json_format(mock_client_manager, mock_org_client, mock_build_hierarchy, mock_config, mock_organization_tree):
