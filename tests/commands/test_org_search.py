...
def test_search_command_basic_functionality(mock_config, sample_account_details):
    ...
    with patch('src.awsideman.commands.org.AWSClientManager') as mock_client_manager, \
         patch('src.awsideman.commands.org.OrganizationsClient') as mock_org_client, \
         patch('src.awsideman.utils.aws_client.search_accounts') as mock_search:
