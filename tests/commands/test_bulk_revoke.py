...
class TestBulkRevokeCommand:
    ...
    def test_bulk_revoke_csv_dry_run(self):
        ...
        try:
            ...
            with patch(
                "src.awsideman.commands.bulk.validate_profile"
                ...
                with patch(
                    "src.awsideman.utils.bulk.processors.FileFormatDetector.get_processor"
                ) as mock_processor, patch(
                    "src.awsideman.utils.bulk.resolver.ResourceResolver"
                ) as mock_resolver, patch(
                    "src.awsideman.utils.bulk.preview.PreviewGenerator"
                ) as mock_preview:
        ...
        try:
            ...
            with patch(
                ...
                with patch(
                    ...
                    "src.awsideman.utils.bulk.batch.BatchProcessor"
                ) as mock_batch_processor, patch(
                    "src.awsideman.utils.bulk.reporting.ReportGenerator"
