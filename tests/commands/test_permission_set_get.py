...
def test_get_permission_set_by_name_successful(
    ...
    mock_sso_admin.describe_permission_set.return_value = {
        "PermissionSet": sample_permission_set
    }
...
def test_get_permission_set_resource_not_found_exception(
    ...
    mock_validate_profile.return_value = ("default", {"region": "us-east-1"})
    mock_validate_sso_instance.return_value = ("arn:aws:sso:::instance/ssoins-1234567890abcdef", "d-1234567890")
    mock_resolve_identifier.return_value = "arn:aws:sso:::permissionSet/ssoins-1234567890abcdef/ps-nonexistent"
    ...
    mock_console.print.assert_any_call("[yellow]Check the permission set name or ARN and try again.[/yellow]")
