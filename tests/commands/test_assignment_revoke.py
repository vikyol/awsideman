...
from src.awsideman.commands.assignment import revoke_assignment
...
def test_revoke_assignment_successful_with_confirmation(
    ...
    mock_console.print.assert_any_call("[green]Permission set assignment revoked successfully![/green]")
