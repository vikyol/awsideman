...
def test_trace_policies_command_table_format(mock_client_manager, mock_org_client, mock_policy_resolver_class, mock_config, mock_policies):
    ...
    mock_policy_resolver._get_hierarchy_path.return_value = Mock(names=["Root", "Engineering", "test-account"])
...
@patch('src.awsideman.commands.org.OrganizationsClient')
@patch('src.awsideman.commands.org.AWSClientManager')
def test_trace_policies_command_json_format(mock_client_manager, mock_org_client, mock_policy_resolver_class, mock_config, mock_policies):
    ...
    try:
        ...
        assert scp_policy["aws_managed"] == True
...
@patch('src.awsideman.commands.org.OrganizationsClient')
@patch('src.awsideman.commands.org.AWSClientManager')
def test_trace_policies_command_no_policies(mock_client_manager, mock_org_client, mock_policy_resolver_class, mock_config):
...
@patch('src.awsideman.commands.org.OrganizationsClient')
@patch('src.awsideman.commands.org.AWSClientManager')
def test_trace_policies_command_policy_resolver_error(mock_client_manager, mock_org_client, mock_policy_resolver_class, mock_config):
    """Test the trace-policies command handles policy resolver errors."""
    # Setup mocks to raise an exception
    mock_policy_resolver = Mock()
    mock_policy_resolver.resolve_policies_for_account.side_effect = Exception("Failed to resolve policies")
    mock_policy_resolver_class.return_value = mock_policy_resolver
...
@patch('src.awsideman.commands.org.OrganizationsClient')
@patch('src.awsideman.commands.org.AWSClientManager')
def test_trace_policies_command_only_scps(mock_client_manager, mock_org_client, mock_policy_resolver_class, mock_config):
...
@patch('src.awsideman.commands.org.OrganizationsClient')
@patch('src.awsideman.commands.org.AWSClientManager')
def test_trace_policies_command_only_rcps(mock_client_manager, mock_org_client, mock_policy_resolver_class, mock_config):
